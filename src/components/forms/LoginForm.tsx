...
const LoginPage = () => {
  ...
  useEffect(() => {
    // Fungsi untuk menangani response sign-in
    window.onSignIn = (googleUser) => {
      ...
      // Di sini Anda bisa menambahkan logika untuk mengirim token ID ke backend
  ...
  return (
    <>
      ...
      <meta
        ...
        content="913107858333-8csadaquuajoeb3pf7hu2l223ia4u6od.apps.googleusercontent.com.apps.googleusercontent.com"
      />
