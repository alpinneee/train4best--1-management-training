    ...
    >
      <div className="flex items-center justify-center min-h-screen">
        ...
        >
          <button
            onClick={onClose}
            className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 text-gray-800 p-1.5 hover:bg-gray-300 rounded-xl bg-gray-100 transition-colors duration-200"
          >
            <svg
          ...
          <div className="text-sm sm:text-base bg-white p-3 rounded-xl text-gray-800">
            {children}
          </div>
        </div>
      </div>
